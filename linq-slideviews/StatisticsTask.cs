...
public class StatisticsTask
{
    ...
    private static IEnumerable<double> GetAllTimes(IEnumerable<(VisitRecord, VisitRecord)> visits, SlideType slideType)
    {
        return visits
    ...
    private static double GetTime((VisitRecord, VisitRecord) visits)
    {
    ...
    private static bool CheckForSlideId((VisitRecord, VisitRecord) visit)
    {
